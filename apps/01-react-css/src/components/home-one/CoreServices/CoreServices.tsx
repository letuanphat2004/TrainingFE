...
export function CoreServices() {
  return (
    <section className="core-services page-component" id="services" aria-labelledby="services-title">
      <SectionHeading
        className="core-services__heading"
      ...
      <div className="core-services__cards">
        {services.map((service) => (
          <ServiceCard
            className={`core-services__card core-services__card--${service.id}`}
            key={service.id}
            {...service}
          />
        ))}
