...
export function ContactUs() {
  return (
    <section id="contact" aria-labelledby="contact-us-title" className="relative z-10 mx-auto my-24 grid w-[calc(100%-48px)] max-w-[1140px] grid-cols-1 gap-y-7 min-[801px]:grid-cols-2 min-[801px]:grid-rows-[auto_auto] min-[801px]:items-center min-[801px]:gap-x-16 min-[801px]:gap-y-8 desktop:my-0 desktop:min-h-[1072px] desktop:w-full desktop:max-w-none desktop:grid-cols-[520px_520px] desktop:grid-rows-[169px_652px] desktop:items-start desktop:gap-x-[100px] desktop:gap-y-11 desktop:px-[150px] desktop:pt-[235px]">
