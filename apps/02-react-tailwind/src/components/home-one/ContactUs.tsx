...
export function ContactUs() {
  return (
    <section id="contact" aria-labelledby="contact-us-title" className="relative z-10 mx-auto my-24 grid w-[calc(100%-48px)] max-w-[1140px] grid-cols-1 gap-y-7 min-[1025px]:grid-cols-2 min-[1025px]:grid-rows-[auto_auto] min-[1025px]:items-center min-[1025px]:gap-x-16 min-[1025px]:gap-y-8 desktop:my-0 desktop:min-h-[1072px] desktop:w-full desktop:max-w-none desktop:grid-cols-[520px_520px] desktop:grid-rows-[169px_652px] desktop:items-start desktop:gap-x-[100px] desktop:gap-y-11 desktop:px-[150px] desktop:pt-[235px]">
      <img src={assets.homeOne.contactAnimation} alt="" aria-hidden="true" className="h-auto w-full max-w-[520px] justify-self-center object-contain min-[1025px]:col-start-1 min-[1025px]:row-span-2 min-[1025px]:row-start-1 desktop:mt-[159px] desktop:h-[614px] desktop:w-[520px]" />

      <SectionHeading
        className="w-full text-center min-[1025px]:col-start-2 min-[1025px]:row-start-1 desktop:h-[169px] desktop:w-[497px] desktop:text-left"
        eyebrow="Contact Us"
      ...
      />
        ...
        <form className="grid w-full grid-cols-1 gap-5 min-[481px]:grid-cols-2 min-[1025px]:col-start-2 min-[1025px]:row-start-2 desktop:h-[652px] desktop:w-[520px] desktop:grid-cols-[242.21px_242.21px] desktop:grid-rows-[61.58px_61.58px_61.58px_239.47px_58px] desktop:gap-x-[35.58px] desktop:gap-y-[38.31px]" onSubmit={(event) => event.preventDefault()}>
