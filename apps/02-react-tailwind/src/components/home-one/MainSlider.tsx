...
export function MainSlider() {
  return (
    <section id="home" aria-labelledby="home-title" className="w-full">
      <div className="relative isolate z-10 flex w-full flex-col px-6 pb-10 pt-12 sm:px-8 md:min-h-[620px] md:pb-14 md:pt-[72px] lg:px-6 xl:min-h-[701px] xl:px-[calc((100%_-_1140px)_/_2)] xl:pb-0 xl:pt-[159px]">
        <img
          src={assets.homeOne.slideBackground}
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute left-0 top-0 -z-10 w-full max-w-[1266.42px] -translate-y-[79px] -scale-x-100 sm:-translate-y-[104px] xl:h-[743px]"
        />
