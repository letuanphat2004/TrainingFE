      ...
      <div className="relative isolate z-0 mx-auto flex w-full max-w-[1440px] flex-col px-6 pt-24 sm:px-12 xl:px-[calc((100%_-_1140px)_/_2)] xl:pt-[134.44px]">
        ...
        <div className="grid w-full grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-8 xl:grid-cols-[664px_476px] xl:gap-0">
          <div className="flex min-w-0 flex-col items-center lg:items-start">
            <SectionHeading
              className="flex w-full max-w-[664px] flex-col items-center gap-3 lg:items-start lg:text-left xl:h-[292px] xl:w-[664px] xl:max-w-none"
              eyebrow="About Us"
            ...
            <div className="mt-12 flex w-full flex-wrap items-start justify-center gap-5 lg:justify-start xl:mt-[49px] xl:flex-nowrap xl:gap-11">
