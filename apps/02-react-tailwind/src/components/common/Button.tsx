...
const baseClasses = "inline-flex min-h-[52px] items-center justify-center rounded-full border-0 bg-accent px-5 font-poppins text-base font-semibold leading-6 tracking-widest text-white shadow-button transition hover:-translate-y-px hover:bg-[#F554A1] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary active:translate-y-0";
